...
- Carritos: (se deshabilito, es decir, se comentó en el código):
...
- Productos:(se deshabilito, es decir, se comentó en el código):
...
- Socket IO:(se deshabilito, es decir, se comentó en el código):
